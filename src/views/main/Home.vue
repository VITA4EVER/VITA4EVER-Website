<template>
        <!-- Cool looking background particles! Yaay!-->
        <div id="shapes" class="backwrap gradient">
            ...
            <div class="text-center flex flex-wrap justify-center align-middle gap-6 mt-6"> <!-- Card container -->
              ...
              <div class="card glass min-w-86 max-w-96 grow shadow-xl m-1">
                ...
                <div class="card-body align-bottom mt-6">
                  ...
                  <p class="text-left">A WIP Killzone Mercenary (KZV) private server.</p>
                </div>
              </div>
              ...
              <div class="card glass min-w-86 max-w-96 grow shadow-xl m-1">
                ...
                <div class="card-body">
                  ...
                  <p class="text-left">We're considering plans to revive an old messaging app for PlayStation Vita.</p>
                </div>
              </div>
            </div> <!-- End of card container -->

            <h1 class="text-center m-2 text-4xl font-bold mt-8">More Information</h1>
